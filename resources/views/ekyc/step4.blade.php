<x-app-layout>
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md mt-8">
        ...
        <form method="POST" action="{{ route('ekyc.step4.store') }}">
            ...
            <div class="mb-4">
                <label class="block font-medium text-gray-700">Alamat Domisili Lengkap</label>
                <textarea name="alamatDomisili" rows="3"
            ...
            {{-- Nama Ibu Kandung --}}
            <div class="mb-4">
                <label class="block font-medium text-gray-700">Nama Ibu Kandung</label>
...
<script>
    ...
    // === Kecamatan ke Kode Pos (input readonly) ===
